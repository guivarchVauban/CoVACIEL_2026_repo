...
# ─────────────────────────────────────────────
# ──────────────────────────────────────────────────────────
#  Architecture de Monitoring : Dashboard complet
# ──────────────────────────────────────────────────────────
WATCHED_NODES: dict[str, list[str]] = {
    # Cœur du robot : Pilotage matériel, Lidar et Orchestration
    "Eliot_jazzy": [
        "/node_controller",   # Ton bridge perso
        "/arduino_bridge",    # Le pont officiel
        "/sllidar_node",      # Lidar
        "/orchestrateur_node" # Ton gestionnaire de nœuds
    ],
    
    # Boucle de contrôle : Pilotage et correction de trajectoire
    "docker_cmdvel": [
        "/nav_tunnel_pid_node"
    ],
